...
- [x] 1.4 Refresh the stale CanvasKit response once across HTTP and Service Worker caches without clearing user data.
...
- [x] 3.3 Synchronize the 241 checkout to the released commit without overwriting remote work.
