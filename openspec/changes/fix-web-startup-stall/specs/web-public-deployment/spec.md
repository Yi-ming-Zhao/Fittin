...
- **THEN** the launch loader bypasses stale HTTP and Service Worker entries, validates the corrected media type, and overwrites only the canonical cached CanvasKit response once before bootstrap
