...
- [x] 5.6 Publish the production Web bundle to the Alibaba Cloud ECS release root, atomically activate it, and verify the public app and phone-sized interactions.
