...
The system MUST provide a profile screen that consolidates account, language, weight tools, reference material, and visual settings.

#### Scenario: User opens profile settings
- **WHEN** the user opens the profile screen
- **THEN** the screen shows account status, language selection, weight-tool access, reference links, and visual adjustment controls in one settings surface.
