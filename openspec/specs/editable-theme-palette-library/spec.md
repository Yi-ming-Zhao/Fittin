...
Define safe user-authored semantic palettes and their Agent mutation boundaries.
...
The system MUST reject malformed color values, cyan or teal hues, insufficient foreground/background contrast, indistinguishable strength/cardio colors, and invisible status roles before saving a palette.
