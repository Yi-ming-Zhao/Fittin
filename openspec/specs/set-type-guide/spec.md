# set-type-guide Specification

## Purpose
Define the bundled in-app guide that explains training set categories and how users should choose them while editing a plan.
