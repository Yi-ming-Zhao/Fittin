...
Future<void> initializeTestIsarCore() async {
  ...
  if (home == null || home.isEmpty) {
    throw StateError(
      'HOME is required to locate isar_flutter_libs test binaries.',
    );
  }

  final pubCacheRoot =
      '$home/.pub-cache/hosted/pub.dev/isar_flutter_libs-3.1.0+1';
  final libraries = <Abi, String>{};

  if (Platform.isMacOS) {
    final libraryPath = '$pubCacheRoot/macos/libisar.dylib';
    libraries.addAll({Abi.macosX64: libraryPath, Abi.macosArm64: libraryPath});
  } else if (Platform.isLinux) {
    final libraryPath = '$pubCacheRoot/linux/libisar.so';
    libraries.addAll({Abi.linuxX64: libraryPath, Abi.linuxArm64: libraryPath});
    ...
    throw UnsupportedError(
      'Unsupported platform for Isar test core: ${Platform.operatingSystem}',
    );
  }
