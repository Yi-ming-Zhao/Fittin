...
\restrict HCXuUWbQEFqM9oARJAxhFjO1M7HIOUME4ZkDcRzzXBXFjLEvC87bmVU72bNtxOS
...
--
-- Name: plan_instances; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.workout_logs (
    ...
    workout_name text DEFAULT ''::text NOT NULL,
    raw_json text NOT NULL,
...
--
-- Name: messages_2026_04_19; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_04_19 OWNER TO supabase_admin;

--
-- Name: messages_2026_04_20; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_04_20 OWNER TO supabase_admin;

--
-- Name: messages_2026_04_21; Type: TABLE; Schema: realtime; Owner: supabase_admin
--
...
ALTER TABLE realtime.messages_2026_04_21 OWNER TO supabase_admin;
...
--
-- Name: messages_2026_04_19; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_20; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_21; Type: TABLE ATTACH; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: plan_instances plan_instances_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: messages_2026_04_19 messages_2026_04_19_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_20 messages_2026_04_20_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_21 messages_2026_04_21_pkey; Type: CONSTRAINT; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_19_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_20_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_21_inserted_at_topic_idx; Type: INDEX; Schema: realtime; Owner: supabase_admin
--
...
--
-- Name: messages_2026_04_19_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_04_19_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_04_20_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_04_20_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_04_21_inserted_at_topic_idx; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: messages_2026_04_21_pkey; Type: INDEX ATTACH; Schema: realtime; Owner: supabase_realtime_admin
--
...
--
-- Name: body_metrics body_metrics own rows; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "body_metrics own rows" ON public.body_metrics USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));


--
-- Name: plan_instances; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.plan_instances ENABLE ROW LEVEL SECURITY;

--
-- Name: plan_instances plan_instances own rows; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "plan_instances own rows" ON public.plan_instances USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: plans plans own rows; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "plans own rows" ON public.plans USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: progress_photos progress_photos own rows; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "progress_photos own rows" ON public.progress_photos USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: workout_logs workout_logs own rows; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "workout_logs own rows" ON public.workout_logs USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: objects authenticated users can delete own progress photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "authenticated users can delete own progress photos" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'progress-photos'::text) AND ((storage.foldername(name))[1] = 'users'::text) AND ((storage.foldername(name))[2] = (auth.uid())::text)));


--
-- Name: objects authenticated users can read own progress photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "authenticated users can read own progress photos" ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'progress-photos'::text) AND ((storage.foldername(name))[1] = 'users'::text) AND ((storage.foldername(name))[2] = (auth.uid())::text)));


--
-- Name: objects authenticated users can update own progress photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "authenticated users can update own progress photos" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'progress-photos'::text) AND ((storage.foldername(name))[1] = 'users'::text) AND ((storage.foldername(name))[2] = (auth.uid())::text))) WITH CHECK (((bucket_id = 'progress-photos'::text) AND ((storage.foldername(name))[1] = 'users'::text) AND ((storage.foldername(name))[2] = (auth.uid())::text)));


--
-- Name: objects authenticated users can upload own progress photos; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "authenticated users can upload own progress photos" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'progress-photos'::text) AND ((storage.foldername(name))[1] = 'users'::text) AND ((storage.foldername(name))[2] = (auth.uid())::text)));
...
--
-- Name: TABLE plan_instances; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.plan_instances TO anon;
GRANT ALL ON TABLE public.plan_instances TO authenticated;
...
--
-- Name: TABLE messages_2026_04_19; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT ALL ON TABLE realtime.messages_2026_04_19 TO postgres;
GRANT ALL ON TABLE realtime.messages_2026_04_19 TO dashboard_user;


--
-- Name: TABLE messages_2026_04_20; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT ALL ON TABLE realtime.messages_2026_04_20 TO postgres;
GRANT ALL ON TABLE realtime.messages_2026_04_20 TO dashboard_user;


--
-- Name: TABLE messages_2026_04_21; Type: ACL; Schema: realtime; Owner: supabase_admin
--

GRANT ALL ON TABLE realtime.messages_2026_04_21 TO postgres;
GRANT ALL ON TABLE realtime.messages_2026_04_21 TO dashboard_user;
...
\unrestrict HCXuUWbQEFqM9oARJAxhFjO1M7HIOUME4ZkDcRzzXBXFjLEvC87bmVU72bNtxOS
