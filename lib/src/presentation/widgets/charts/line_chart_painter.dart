...
class LineChartPainter extends CustomPainter {
  ...
  final Color pointShadowColor;
  final Color pointCoreColor;
  ...
  LineChartPainter({
    ...
    required this.pointShadowColor,
    required this.pointCoreColor,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final dataset in datasets) {
      ...
      for (final point in dataset.points) {
        ...
        // Inner core
        canvas.drawCircle(Offset(x, y), 2.5, Paint()..color = pointCoreColor);
      }
    }
  }
  ...
  bool shouldRepaint(covariant LineChartPainter oldDelegate) {
    return oldDelegate.datasets != datasets ||
        ...
        oldDelegate.pointShadowColor != pointShadowColor ||
        oldDelegate.pointCoreColor != pointCoreColor;
  }
}
