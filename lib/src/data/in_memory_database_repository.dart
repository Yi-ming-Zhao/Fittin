...
class InMemoryDatabaseRepository extends DatabaseRepository {
  ...
  final Map<String, String?> _homeDisplayNamesByOwner = {};
  final Map<String, DateTime?> _homeMilestonesLastSeenAtByOwner = {};
  ...
  Future<void> saveInstance(
    ...
    _instances[data.instanceId] = data.copyWith(
      syncStatus: syncStatus ?? data.syncStatus,
      lastModifiedByDeviceId: deviceId ?? data.lastModifiedByDeviceId,
    );
  }
  ...
  Future<String?> fetchHomeDisplayName({String? ownerUserId}) async {
    return _homeDisplayNamesByOwner[_ownerScope(ownerUserId)];
  }

  @override
  Future<void> saveHomeDisplayName(String value, {String? ownerUserId}) async {
    final trimmed = value.trim();
    _homeDisplayNamesByOwner[_ownerScope(ownerUserId)] = trimmed.isEmpty
        ? null
        : trimmed;
  }
  ...
  Future<void> clearHomeDisplayName({String? ownerUserId}) async {
    _homeDisplayNamesByOwner.remove(_ownerScope(ownerUserId));
  }

  @override
  Future<DateTime?> fetchHomeMilestonesLastSeenAt({String? ownerUserId}) async {
    return _homeMilestonesLastSeenAtByOwner[_ownerScope(ownerUserId)];
  }
  ...
  Future<void> saveHomeMilestonesLastSeenAt(
    ...
    _homeMilestonesLastSeenAtByOwner[_ownerScope(ownerUserId)] = value;
  }
